...
public class FilesTest extends ClusteredTestBase {
    ...
    public void testWriteToNodeA() throws Exception {
        ...
        ms.put(FilesTest.class.getSimpleName(), service.getBlobKey(file).getKeyString());
    ...
    public void testReadFromNodeB() throws Exception {
        ...
        MemcacheService ms = MemcacheServiceFactory.getMemcacheService();
        String string = (String) ms.get(FilesTest.class.getSimpleName());
