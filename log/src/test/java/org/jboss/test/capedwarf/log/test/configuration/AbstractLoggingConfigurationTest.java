...
import org.jboss.test.capedwarf.log.test.AbstractLoggingTest;

/**
 * @author Marko Luksa
 */
public abstract class AbstractLoggingConfigurationTest extends AbstractLoggingTest {
    ...
    protected static Archive getDeploymentWithLoggingLevelSetTo(Level level) {
        ...
        war.addClass(AbstractLoggingConfigurationTest.class);
