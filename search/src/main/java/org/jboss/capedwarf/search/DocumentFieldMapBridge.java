 ...
 */
public class DocumentFieldMapBridge implements FieldBridge {

    @SuppressWarnings("unchecked")
    public void set(String name, Object value, Document document, LuceneOptions luceneOptions) {
        Map<String, List<Field>> map = (Map<String, List<Field>>) value;
        for (List<Field> fields : map.values()) {
    ...
    private String convertToString(Field field) {
