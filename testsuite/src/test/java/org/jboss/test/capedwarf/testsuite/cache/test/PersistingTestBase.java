 ...
 */
public abstract class PersistingTestBase extends TestsuiteTestBase {
    protected static WebArchive getBaseDeployment() {
        return getCapedwarfDeployment().addClasses(PersistingTestBase.class, TestsuiteTestBase.class);
    }
