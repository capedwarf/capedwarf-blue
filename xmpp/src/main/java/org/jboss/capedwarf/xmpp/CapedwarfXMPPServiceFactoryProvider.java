...
import com.google.appengine.api.xmpp.IXMPPServiceFactory;
...
@ServiceProvider(value = IXMPPServiceFactory.class, precedence = CapedwarfFactoryProvider.PRECEDENCE)
public class CapedwarfXMPPServiceFactoryProvider extends CapedwarfFactoryProvider<IXMPPServiceFactory> {
    ...
    public CapedwarfXMPPServiceFactoryProvider() {
