...
@ServiceProvider(value = IAppIdentityServiceFactory.class, precedence = CapedwarfFactoryProvider.PRECEDENCE)
public class CapedwarfAppIdentityServiceFactoryProvider extends CapedwarfFactoryProvider<IAppIdentityServiceFactory> {
    ...
    public CapedwarfAppIdentityServiceFactoryProvider() {
