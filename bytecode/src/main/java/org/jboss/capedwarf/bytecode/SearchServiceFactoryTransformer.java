...
public class SearchServiceFactoryTransformer extends JavassistTransformer {
    protected void transform(CtClass clazz) throws Exception {
        ...
        method.setBody(toProxy(SearchService.class, "new org.jboss.capedwarf.search.CapedwarfSearchService()"));

        CtMethod method2 = clazz.getDeclaredMethod("getSearchService", new CtClass[]{clazz.getClassPool().get("java.lang.String")});
        method2.setBody(toProxy(SearchService.class, "new org.jboss.capedwarf.search.CapedwarfSearchService($1)"));
    }
}
