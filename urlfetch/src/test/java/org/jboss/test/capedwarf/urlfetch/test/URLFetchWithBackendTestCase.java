...
@Category(All.class)
public class URLFetchWithBackendTestCase extends BaseTest {

    @Deployment
    public static WebArchive getDeployment() {
        WebArchive war = getCapedwarfDeployment();
        war.addAsWebInfResource("backends-uf.xml", "backends.xml");
        return war;
    }
    ...
    public void testBasicOps() throws Exception {
        ...
        URL adminConsole = new URL("http://backend/_ah/admin");
